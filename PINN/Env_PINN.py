...
class AISimEnv1v1_PINN:
    ...
    def __init__(self,
        ...
        self.blue = Agent_1V1_Blue(BLUE_AGENT_ID)
    ...
    # 重新开始一局
    def reset(self, sc, index, alt_exp, spd_exp, pidParams):
        # self.red.reset()
        self.blue.reset(alt_exp, spd_exp, pidParams)
        self.judge.reset()
        if self.need_record:
